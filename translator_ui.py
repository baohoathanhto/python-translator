...
class TranslatorApp(tk.Tk):
    ...
    def setup_style(self):
        ...
        self.saved_theme = utils.load_theme("ttkb_theme")
    ...
    def setup_gui(self):
        ...
        self.chinese_textbox = ttkb.Text(self.chinese_tab, width=200, spacing1=5, spacing2=5, wrap="word")
        self.hanviet_textbox = ttkb.Text(self.hanviet_tab, width=200, spacing1=5, spacing2=5, wrap="word")
        self.vietnamese_textbox = ttkb.Text(self.vietnamese_tab, width=200, spacing1=5, spacing2=5, wrap="word")

        # Set font and size for textboxes
        current_font = self.chinese_textbox.cget("font")
        self.chinese_textbox.config(font=(current_font[0], 12), state="disabled")
        self.hanviet_textbox.config(font=(current_font[0], 12), state="disabled")
        self.vietnamese_textbox.config(font=(current_font[0], 12), state="disabled")
        ...
        self.theme_label = ttkb.Label(self.frame_row2, text="Choose theme:")
        ...
        # Setup layout
        self.highlighted_textbox.pack(fill=tk.BOTH, expand=True, padx=(10, 5), pady=(10, 5))
    ...
    def change_theme(self, event):
        ...
        utils.save_theme("ttkb_theme", selected_theme)
